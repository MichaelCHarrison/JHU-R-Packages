...
#'
#' @param x a n x p matrix of n observations na dp predictors
#' @param y a vector of length n representing the response
#' @return a vector of coefficients from the final fitted model with top 10 features
#' @author Michael Harison
#' @details
#' This function runs a univariate regression of y on each predicor in x and
#' calculates a p-value indicating the significance of the association. the final
#' set of 10 predictors is taken from the 10 smallest p-values.
#' @seealso \code{lm}
#' @export
#' @importFrom stats lm
...
#' function and makes a prediction for each of the values provided in the input 'X'
#' matrix
#'
